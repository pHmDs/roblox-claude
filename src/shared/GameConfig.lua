...
GameConfig.Stages = {
	[1] = {
		...
		enemyHp = 20,
		reward = 8,
		enemyColor = Color3.fromRGB(140, 220, 235), -- azul-piscina claro: "banheiro" continua legivel, mas alegre
	...
	[2] = {
		...
		enemyHp = 400,
		reward = 100,
		enemyColor = Color3.fromRGB(40, 185, 220), -- turquesa tropical, mais vivo que o azul-marinho anterior
		enemyCount = 6,
		enemySpeed = 13,
		enemyDamage = 20,
		winsRequired = 3,
